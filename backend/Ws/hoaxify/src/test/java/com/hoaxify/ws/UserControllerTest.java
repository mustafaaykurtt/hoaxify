...
public class UserControllerTest {
	...
	public void postUser_whenUserIsInvalid_receiveApiError() {
		...
		assertThat(response.getBody().getPath()).isEqualTo(API_1_0_USERS);
	}
	...
	public void putUser_whenUnauthorizedUserSendsTheRequest_receiveApiError() {
		...
		assertThat(response.getBody().getPath()).contains("users/123");
	}
	...
	public void putUser_whenAuthorizedUserSendsUpdateForAnotherUser_receiveApiError() {
		...
		assertThat(response.getBody().getPath()).contains("users/"+anotherUserId);
	}
	...
	public void cleanDirectory() throws IOException {
		FileUtils.cleanDirectory(new File(appConfiguration.getProfileStoragePath()));
		FileUtils.cleanDirectory(new File(appConfiguration.getAttachmentStoragePath()));
	}
